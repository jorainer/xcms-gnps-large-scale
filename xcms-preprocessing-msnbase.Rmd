...
subtitle: "Supporting Information for: *xcms in peak form: Now anchoring a complete metabolomics data preprocessing and analysis software ecosystem*"
output:
...
GNPS. For the present analysis, *xcms* version 3.7.2, part of Bioconductor
release 3.10, was used. This version of *xcms* uses the mass spectrometry data
infrastructure and data objects from the *MSnbase* package. To evaluate the
performance, memory usage and timing of function calls are recorded during the
analysis.
